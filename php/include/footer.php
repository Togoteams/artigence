      ...
      <div class="row mt-4 thin-strip">
        ...
        <div class="col-md-4 text-center">
          <p class="mt-3 mb-2 text-muted">All Content Copyright 2025 |
            <a href="privacy-policy.php" class="text-dark text-decoration-none">Privacy Policy</a> |
            <a href="terms-condition.php" class="text-dark text-decoration-none">Terms of Use</a>
          </p>
        </div>
        <div class="col-md-4"></div>
      </div>
